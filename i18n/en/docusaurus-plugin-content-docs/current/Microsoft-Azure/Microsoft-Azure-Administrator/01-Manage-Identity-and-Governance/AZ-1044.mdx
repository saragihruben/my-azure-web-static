...
***Image Source*** : *https://learn.microsoft.com/en-us/training/modules/sovereignty-policy-initiatives/cloud-adoption-framework*
<br/>
...
***Image Source*** : *https://learn.microsoft.com/en-us/training/modules/sovereignty-policy-initiatives/azure-policy-design-principles*
...
***Image Source*** : *https://learn.microsoft.com/en-us/training/modules/sovereignty-policy-initiatives/azure-policy-resources*
...
The first part of the `policyRule` in an Azure Policy definition is the `if` block. This block defines the conditions used by the rule to evaluate resources. 
A rule definition can contain multiple condition statements. Depending on the evaluation logic used, it may require all statements to be true, or just some of them.
...
A condition in an Azure Policy evaluates whether the values of properties such as **Fields**, **Value**, or **Count** meet specific criteria. If the result of a function causes an error, the policy will result in a `deny` effect. 
...
Functions can be used to add additional logic to a policy. These functions are resolved within the policy definition and in parameter values assigned to policy initiatives. 
