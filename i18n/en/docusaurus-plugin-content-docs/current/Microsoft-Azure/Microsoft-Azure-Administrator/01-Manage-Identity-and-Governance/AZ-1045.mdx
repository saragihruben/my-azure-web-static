...
Organizations can grant access by assigning appropriate Azure roles to users, groups, or applications at a specific scope. This scope could be a **management group**, **subscription**, **resource group**, or **individual resource**, and is *inherited* based on the hierarchy.
...
In the Azure Portal, users will find an **Access control** panel known as **Identity and Access Management (IAM)**. In this panel, users can view who has access, what their roles are, and grant or revoke access at a defined scope. 
