...
**Network File System (NFS)**. Azure file shares do not support both SMB and NFS protocols on the same file share, though users can create SMB and NFS Azure file shares in the same storage account.
