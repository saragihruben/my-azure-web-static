...
**How to Access It?**  
While in the Azure portal, the Azure Advisor dashboard displays personalized recommendations for all your subscriptions.  
...
It supports simple to complex queries, statistical analysis, and visualization of results.  
These queries can be used in other Azure Monitor features like:  
- Log-based alerts  
- Workbooks  
